package cn.skuu.infra.service.config;

import cn.hutool.core.util.StrUtil;
import cn.iocoder.yudao.framework.common.pojo.PageResult;
import cn.skuu.infra.controller.admin.config.vo.ConfigCreateReqVO;
import cn.skuu.infra.controller.admin.config.vo.ConfigExportReqVO;
import cn.skuu.infra.controller.admin.config.vo.ConfigPageReqVO;
import cn.skuu.infra.controller.admin.config.vo.ConfigUpdateReqVO;
import cn.skuu.infra.convert.config.ConfigConvert;
import cn.skuu.infra.dal.dataobject.config.ConfigDO;
import cn.skuu.infra.dal.mysql.config.ConfigMapper;
import cn.skuu.infra.enums.config.ConfigTypeEnum;
